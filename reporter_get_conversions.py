...
def writeCSV(csvPath, masterStatsArray):
    with open(csvPath, 'w', encoding='utf-8') as csvfile:
        fieldnames = ['UTM', 'UTM Source', 'Medium', 'Referrer', 'Count']
        ...
        for channelEntry in masterStatsArray:
            ...
            dumboFormat = {
                'UTM': channelEntry[0],
                'UTM Source': channelEntry[1],
                'Medium': channelEntry[2],
                'Referrer': channelEntry[3],
                'Count': channelEntry[4],
            }
...
utm_term = get_utms_from_csv('/Users/michaelninh/PycharmProjects/inventus/csvRaws/7%2F23 - 7%2F29 - get_conv (1).csv')
# utm_term = [('15767',)]
...
exportPath = '/Users/michaelninh/PycharmProjects/inventus/exports/weekconversions.csv'
