...
def run_video_statistics(client, videoId):
    ...
    print('the category id is' + create_video.categoryId)
    ...
    # RETRO FUNCTION REPLACES ALL VIDEO DATA
    c.execute("INSERT OR REPLACE INTO video VALUES (:videoId, :creatorId, :publishedAt, :title, :videoTags, "
